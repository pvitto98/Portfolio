  ...
  const projectData = [
    {
      ...
      technologies: ["React, Three.js", "HTML / CSS / JS", "Cookie Policy"],
      credits: ["Copywriting: CC, VS", "Design : CC, VS, Me", "Development : Me"],
      content: [
    ...
    },
    {
      ...
      technologies: ["React + Node.js", "MongoDB, Netlify, Render"],
